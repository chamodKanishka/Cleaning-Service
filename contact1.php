...
<head>
        ...
        <title>Chillclean - Cleaning Services </title><link rel="shortcut icon" type="image/x-icon" href="favicon.ico">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-4 logo col-md-12 d-flex align-items-center">
							...
							<a href="index-2.php">
								<img src="assets/images/des.jpeg" alt="Logo" width="222" height="75">
								</a>		
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 col-lg-8 offset-md-2 text-center">
          <h2>KEEP IN TOUCH</h2>
          <p class="lead"> tell about us. </p>
        </div>
      </div>
      <div class="row">
        <div class="col-md-12 col-lg-12 contact pb-40 pt-30">
          <div class="row text-center">
            <div class="col-md-4 col-lg-4 pb-xs-30"> <i class="ion-android-call icon-circle pos-s"></i><a href="#" class="mt-15 i-block">+971 7584767</a> </div>
            <div class="col-md-4 col-lg-4 pb-xs-30"> <i class="ion-ios-location icon-circle pos-s"></i>
              <p  class="mt-15"> 140/7,Colombo Rd,Horana, <br />
                Horana,Sri Lanka. </p>
            </div>
