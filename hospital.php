...
<head>
		...
		<meta name="Hospital clean" content="hospital cleaning services" />
		<meta name="materials" content="hospital materials" />
		<meta name="cleaning request" content="request for cleanings" />
		<meta name="public space" content="hospitals public places" />
							...
							<form class="contact-form " id="contact">
								...
								<div class="row">
									<div class="col-lg-6">
                                        ...
                                        <img src="assets\images\place\hos.png" alt="hospital" width="1000" height="300">
                                        </div>
										<div class="form-field">
							...
							<div class="contact-info">
								...
								<ul class="info">
									<li>
										...
										<div class="content">
											<p>
                                            Hospitals need a special way to be taken care of, not only are the hours very flexible, and does every shift requires its cleaning team. Also is the way we clean very much different than other sectors. 

Disinfection is almost a standard in hospitals and retirement homes
