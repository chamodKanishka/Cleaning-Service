						...
						<div class="col-lg-8 col-md-12">
							...
							<ul>
									<li>
										...
										<p>
											140/7 Colombo Rd,Horana
											<span> Sri Lanka, 12305</span>
										</p>
									</li>
									<li>
									...
									<li>
										...
										<p>
											Mail Us
											<span> <a href="lahiruhiranw@gmail.com">lahiruhiranw@gmail.com</a> </span>
										</p>
									</li>
								</ul>
							</div>
							...
							<div class="special-links">
								<ul>
									<li>
                                        ...
                                        <a class="active" href="servise-details-corona.php">Special cleaning for COVID-19</a>
									</li>
									<li>
										<a href="404.php">Apartment Cleaning</a>
									</li>
									<li>
										<a href="404.php">Carpet Cleaning</a>
									</li>
									<li>
										<a href="404.php">After Renovation</a>
									</li>
									<li>
										<a href="404.php">Commercial Cleaning</a>
									</li>
									<li>
										<a href="404.php">Residential Cleaning</a>
										
									</li>
									
									<li>
                                    <a  href="services-details.php">House Cleaning</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="col-lg-8 mt-xs-30 mt-sm-30">
						...
						<div class="text-box mt-40">
							<div class="box-title mb-20">
								<h2>Hospital and house cleaning servise for prevent COVID-19</h2>
							</div>
							<div class="text-content">
								<p>
									We provide high quality cleaning servise in for prevent COVID-19 in this dangoruse situation.You all can get this servise by contact us of make a mesage.
								</p>
								<p>
									Be carefull.Prevent from the COVID-19
								</p>
							</div>
							<div class="row mt-45 mt-xs-15 clearfix">
								...
								<div class="col-md-7 text-box">
									...
									<div class="text-content">
										<p>
											Wash your hand regulary with the hand wash.Only water it;s not the solution for that.
										</p>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-12 service-box mt-30 mt-xs-0">
									...
									<div class="text-content mb-30">
										<p>
											We had more packages for your.As your wish you can choose them.There have more flexible pacages for the houses,Hospitals, & other premises.
										</p>
									</div>
									<div id="accordion" role="tablist" aria-multiselectable="true">
										<div class="card">
											<div class="card-header" role="tab" id="headingOne">
												<h5 class="mb-0 panel-title"><a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne"> How spread COVID-19 <i class="fa fa-plus collape-plus"></i> </a></h5>
											</div>
										...
										<div class="card">
											<div class="card-header" role="tab" id="headingTwo">
												<h5 class="mb-0 panel-title"><a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"> How to identify covid-19 <i class="fa fa-plus collape-plus"></i> </a></h5>
											</div>
...
More rarely, the disease can be serious and even fatal. Older people, and people with other medical conditions (such as asthma, diabetes, or heart disease), may be more vulnerable to becoming severely ill.
										...
										<div class="card">
											<div class="card-header" role="tab" id="headingThree">
												<h5 class="mb-0 panel-title"><a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree"> How to prevent from COVID-19<i class="fa fa-plus collape-plus"></i> </a></h5>
											</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-lg-3 footer_logo">
						<a href="index-2.php"><img src="assets/images/des.jpeg" alt="Logo" width="222" height="75"></a>
						<p>
                        we are the best cleaning company in the world.						</p>
						<ul>
							<li>
					...
					<div class="col-md-6 col-lg-4 mt-sm-30 mt-xs-30 footer-subscribe">
						<h4>Subscribe Us</h4>
						<p>
						Get more about us.Beon ALERT!
						</p>
						<form action="reg2.php" metthod="post">
							<input type="text" placeholder="Enter your e-mail" name="email">
							<button class="btn-text" type="submit" id="submit" name="submit">
											Subscribe
										</button>
						</form>
