							...
							<div class="contact-info">
								...
								<ul class="info">
									<li>
										...
										<div class="content">
											<p>
                                            Covid-19 has a big impact on our way of <br>living. With our Covid-19 team we<br> disinfect all areas requested by you. It’s <br>
                                            imperative to know that the corona virus <br>is spread through cough, 
                                            sneezes or<br> talking, every publicly visited place is <br>contaminated, therefor is disinfection so<br> important. 
								...
								<div class="row">
									<div class="col-lg-6">
										<div class="form-field">
											<!-- <input class="input-sm form-full" id="name" type="text" name="form-name" placeholder="Your Name"> -->
                                            <p>
                                            Contamination not only happens by talking, sneezing or coughing but also by just taking a 
                                            products in the shelf, paying through a terminal, touching the cashier point in the supermarkets 
                                            or touching the door of a toilet. Our disinfection devices and methods are unique and very effective.
			...
			<section class="padding ptb-xs-40">
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-lg-8 contact mt-sm-30 mt-xs-30">
							
							<div class="contact-info"><form class="contact-form " id="contact">
								<!-- IF MAIL SENT SUCCESSFULLY -->
