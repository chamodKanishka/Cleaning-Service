				...
				<div class="row">
					<div class="col-lg-4 col-sx-12">
						<div class="single-sidebar-widget">
							<div class="special-links">
								<ul>
									<li>
										<a class="active" href="services-details.php">House Cleaning</a>
									</li>
									<li>
									...
									<li>
										<a href="services-details.php">Special cleaning for COVID-19</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="col-lg-8 mt-xs-30 mt-sm-30">
						...
						<div class="text-box mt-40">
							...
							<a class="btn-text" href="pricing.php">Hire</a>
						</div>
					</div>
				</div>
			</div>
